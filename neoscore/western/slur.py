...
class Slur(AbstractSlur, MusicPath, Spanner2D):
    ...
    #     if self.length > max_length_considered:
    #         return max_height
    #     if self.length < min_length_considered:
    #         return min_height
    #     return interpolate(
    ...
    #     if self.length > max_spanner_length_considered:
    #         return max_arch_length
    #     if self.length < min_spanner_length_considered:
