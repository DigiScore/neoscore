...
class TestMapping(unittest.TestCase):
    ...
    def test_map_between(self):
        ...
        destination = InvisibleObject((Unit(99), Unit(90)), neoscore.document.pages[4])
    ...
    def test_map_between_with_common_parent(self):
        parent = InvisibleObject((Unit(5), Unit(6)), neoscore.document.pages[0])
    ...
    def test_map_between_where_dest_parent_is_src(self):
        source = InvisibleObject((Unit(1), Unit(2)), neoscore.document.pages[0])
    ...
    def test_map_between_where_src_parent_is_dest(self):
        destination = InvisibleObject((Unit(3), Unit(10)), neoscore.document.pages[0])
