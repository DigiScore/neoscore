...
class TestStaff(unittest.TestCase):
    ...
    def test_staff_pos_to_top_down(self):
        test_staff = Staff((0, 0), 100, self.frame, line_count=5)
        # Center of staff
    ...
    def test_height(self):
        ...
        self.assertAlmostEqual(
            Staff((0, 0), 100, self.frame, staff_unit=1.5, line_count=5).height, 6)
        self.assertAlmostEqual(
            Staff((0, 0), 100, self.frame, staff_unit=1, line_count=5).height, 4)
        # 4 lines
        self.assertAlmostEqual(
            Staff((0, 0), 100, self.frame, staff_unit=1.5, line_count=4).height, 4.5)
        self.assertAlmostEqual(
    ...
    def test_position_outside_staff_with_even_line_count(self):
        test_staff = Staff((0, 0), 100, self.frame, line_count=4)
        assert(test_staff._position_outside_staff(0) is False)
