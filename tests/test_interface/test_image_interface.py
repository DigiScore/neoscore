...
class TestImageInterface(AppTest):
    def test_pixmap_image_loading(self):
        interface = ImageInterface(
            Point(Unit(5), Unit(6)), None, 1, 0, 0, ORIGIN, pixmap_image_path
        )
        interface.render()
    ...
    def test_pixmap_qt_item_properties(self):
        ...
        interface = ImageInterface(
            Point(Unit(5), Unit(6)), None, 2, 3, 4, transform_origin, pixmap_image_path
        )
    ...
    def test_svg_image_loading(self):
        interface = ImageInterface(
            Point(Unit(5), Unit(6)), None, 1, 1, 0, ORIGIN, svg_image_path
        )
        interface.render()
    ...
    def test_svg_qt_item_properties(self):
        transform_origin = Point(Unit(12), Unit(12))
        interface = ImageInterface(
            Point(Unit(5), Unit(6)), None, 2, 3, 4, transform_origin, svg_image_path
        )
