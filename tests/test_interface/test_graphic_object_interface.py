...
class TestGraphicObjectInterface(unittest.TestCase):
    ...
    def test_interface_properties_after_init(self):
        grob = MockGraphicObjectInterface(None, (GraphicUnit(5), GraphicUnit(6)))
    ...
    def test_pos_setter_changesqt_object(self):
        grob = MockGraphicObjectInterface(None, (GraphicUnit(0), GraphicUnit(0)))
    ...
    def test_brush_after_init(self):
        brush = BrushInterface(None, Color("#eeeeee"), BrushPattern.SOLID)
        grob = MockGraphicObjectInterface(None, (5, 6), brush=brush)
    ...
    def test_brush_setter_changesqt_object(self):
        grob = MockGraphicObjectInterface(None, (5, 6), brush=None)
        brush = BrushInterface(None, Color("#eeeeee"), BrushPattern.SOLID)
        grob.brush = brush
        assert grob.qt_object.brush() == grob.brush.qt_object
