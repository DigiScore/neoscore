...
class TestQClippingPath(unittest.TestCase):
    ...
    def test__create_clipping_area_covering_full_path(self):
        painter_path = QtGui.QPainterPath()
        painter_path.lineTo(100, 200)
        path_item = QClippingPath(painter_path, 0, 500)
        clip_area = path_item._create_clipping_area(painter_path, None, None)
        expected_rect = painter_path.boundingRect()
        result_rect = clip_area.boundingRect()
    ...
    def test__create_clipping_area_starting_in_path(self):
        painter_path = QtGui.QPainterPath()
        painter_path.lineTo(100, 200)
        path_item = QClippingPath(painter_path, 0, 500)
        clip_area = path_item._create_clipping_area(painter_path, 50, None)
        result_rect = clip_area.boundingRect()
    ...
    def test__create_clipping_area_ending_in_path(self):
        painter_path = QtGui.QPainterPath()
        painter_path.lineTo(100, 200)
        path_item = QClippingPath(painter_path, 0, 500)
        clip_area = path_item._create_clipping_area(painter_path, None, 50)
        result_rect = clip_area.boundingRect()
    ...
    def test__create_clipping_area_starting_and_ending_in_path(self):
        painter_path = QtGui.QPainterPath()
        painter_path.lineTo(100, 200)
        path_item = QClippingPath(painter_path, 0, 500)
        clip_area = path_item._create_clipping_area(painter_path, 25, 30)
        result_rect = clip_area.boundingRect()
