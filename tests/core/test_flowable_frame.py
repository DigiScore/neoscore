...
class TestFlowableFrame(unittest.TestCase):
    ...
    def test_local_space_to_doc_space_in_first_line(self):
        ...
        assert(test_frame._local_space_to_doc_space(test_pos) ==
               Point(expected_x, expected_y))

    def test_local_space_to_doc_space_second_line(self):
        frame_pos = Point(Mm(10), Mm(11))
    ...
    def test_local_space_to_doc_space_in_third_line(self):
    ...
    def test_local_space_to_doc_space_on_second_page_first_line(self):
        frame_pos = Point(Mm(17), Mm(11))
        test_frame = FlowableFrame(frame_pos, Mm(2500), Mm(15), Mm(5))
    ...
    def test_local_space_to_doc_space_on_second_page_second_line(self):
        frame_pos = Point(Mm(17), Mm(11))
        test_frame = FlowableFrame(frame_pos, Mm(2500), Mm(15), Mm(5))
